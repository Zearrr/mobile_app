  ...
  const onSubmit = async (data: LoginFormData) => {
    try {
      ...
      if (success) {
        ...
        // Redirect based on username (admin/staff)
      ...
      <Card className="w-full max-w-md mx-4 glass-card shadow-2xl relative z-10 border-0 bg-white/10 backdrop-blur-xl">
        ...
        <CardContent className="space-y-8">
          ...
          <div className="text-center space-y-4">
            <div className="พ-4 bg-white/10 rounded-xl backdrop-blur-sm border border-white/20">
              <h4 className="text-sm font-medium text-white/90 mb-2">บัญชีทดสอบ:</h4>
              <div className="space-y-1 text-xs text-white/70">
                <div><strong>Admin:</strong> admin / admin</div>
                <div><strong>Staff:</strong> staff / staff</div>
                <div><strong>หรือ:</strong> ใส่ชื่อที่มีคำว่า "admin" หรือ "staff"</div>
              </div>
            </div>
