      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        <Card>
          <CardContent className="p-5">
            <div className="flex items-start justify-between">
              <div>
                <div className="thai-text text-muted-foreground text-sm">รายรับรวม</div>
                <div className="text-3xl font-extrabold text-emerald-600">{formatCurrency(sums.cashIn)}</div>
                <div className="thai-text text-xs text-muted-foreground">บาท</div>
              </div>
        ...
        <Card>
          <CardContent className="p-5">
            <div className="flex items-start justify-between">
              <div>
                <div className="thai-text text-muted-foreground text-sm">รายจ่ายรวม</div>
                <div className="text-3xl font-extrabold text-amber-600">{formatCurrency(sums.cashOut)}</div>
                <div className="thai-text text-xs text-muted-foreground">บาท</div>
              </div>
        ...
        <Card>
          <CardContent className="p-5">
            <div className="flex items-start justify-between">
              <div>
                <div className="thai-text text-muted-foreground text-sm">โอนเข้า</div>
                <div className="text-3xl font-extrabold text-emerald-600">{formatCurrency(sums.transferIn)}</div>
                <div className="thai-text text-xs text-muted-foreground">บาท</div>
              </div>
              <div className="w-10 h-10 rounded-xl bg-emerald-600 text-white flex items-center justify-center shadow-md">
        ...
        <Card>
          <CardContent className="p-5">
            <div className="flex items-start justify-between">
              <div>
                <div className="thai-text text-muted-foreground text-sm">พร้อมเพย์เข้า</div>
                <div className="text-3xl font-extrabold text-indigo-600">{formatCurrency(sums.promptpayIn)}</div>
                <div className="thai-text text-xs text-muted-foreground">บาท</div>
              </div>
        ...
        <Card>
          <CardContent className="p-5">
            <div className="flex items-start justify-between">
              <div>
                <div className="thai-text text-muted-foreground text-sm">บัตรเข้า</div>
                <div className="text-3xl font-extrabold text-violet-600">{formatCurrency(sums.cardIn)}</div>
                <div className="thai-text text-xs text-muted-foreground">บาท</div>
              </div>
