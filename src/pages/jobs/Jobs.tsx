					...
					<CardHeader>
						<div className="flex items-center justify-between gap-4 flex-wrap">
							...
							<div className="flex gap-3 md:gap-4 flex-wrap">
								<div className="rounded-full px-5 py-2.5 bg-[#0fb50f] hover:bg-[#0da40d] text-white shadow-[0_10px_14px_rgba(0,0,0,0.18)] min-w-[130px] text-center transition-colors">
								...
								<div className="rounded-full px-5 py-2.5 bg-[#0796bd] hover:bg-[#0686a9] text-white shadow-[0_10px_14px_rgba(0,0,0,0.18)] min-w-[130px] text-center transition-colors">
									<div className="text-[11px] thai-text">ต้นทุน</div>
									<div className="text-base font-extrabold">฿{filteredStats.cost.toLocaleString()}</div>
								</div>
								<div className="rounded-full px-5 py-2.5 bg-[#c89200] hover:bg-[#b78300] text-white shadow-[0_10px_14px_rgba(0,0,0,0.18)] min-w-[130px] text-center transition-colors">
